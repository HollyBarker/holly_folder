...
stepvec=[0 26 35 104 219 250 278 450 700];

baseName='/home/mbcx3hb2/Documents/First_Year_Report/Graphs/Data/TEMPERATURE_TIMESTEPS/diff_0._';
stepName='step';
fileType='.dat';

Solution_Temperature=zeros(5000,6,9);
...
for stepnum=1:1:9
    ...
    x= cell2mat(raw(:, 1));
    Solution_Temperature(:,6,stepnum) = cell2mat(raw(:, 2));
    ...
    for dnum=1:1:5
        ...
        x= cell2mat(raw(:, 1));
        Solution_Temperature(:,dnum,stepnum) = cell2mat(raw(:, 2));
