...
stepvec=[0 26 35 98 120 180 210 250 450 700];

baseName='/home/mbcx3hb2/Documents/First_Year_Report/Graphs/Data/DISPLACEMENT_TIMESTEPS/diff_0._';
stepName='step';
fileType='.dat';

Solution_Displacement=zeros(5000,6,10);
...
for stepnum=1:1:10
    ...
    x= cell2mat(raw(:, 1));
    Solution_Displacement(:,6,stepnum) = cell2mat(raw(:, 2));
    ...
    for dnum=1:1:5
        ...
        x= cell2mat(raw(:, 1));
        Solution_Displacement(:,dnum,stepnum) = cell2mat(raw(:, 2));
