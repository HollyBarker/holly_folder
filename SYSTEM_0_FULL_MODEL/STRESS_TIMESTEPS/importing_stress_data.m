...
stepvec=[0 100 350 750];

baseName='/home/mbcx3hb2/Documents/First_Year_Report/Graphs/Data/STRESS_TIMESTEPS/diff_0._';
stepName='step';
fileType='.dat';

Solution_Stress=zeros(5000,6,4);
...
for stepnum=1:1:4
    ...
    x= cell2mat(raw(:, 1));
    Solution_Stress(:,6,stepnum) = cell2mat(raw(:, 2));
    ...
    for dnum=1:1:5
        ...
        x= cell2mat(raw(:, 1));
        Solution_Stress(:,dnum,stepnum) = cell2mat(raw(:, 2));
