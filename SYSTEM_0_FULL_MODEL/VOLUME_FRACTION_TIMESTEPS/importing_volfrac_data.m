...
stepvec=[0,26,65,98,134,245,307,378,450,700];

baseName='/home/mbcx3hb2/Documents/First_Year_Report/Graphs/Data/VOLUME_FRACTION_TIMESTEPS/diff_0._';
stepName='step'
fileType='.dat';

Solution_Volume_Fraction=zeros(5000,6,10);
...
for stepnum=1:1:10
    ...
    x= cell2mat(raw(:, 1));
    Solution_Volume_Fraction(:,6,stepnum) = cell2mat(raw(:, 2));
    ...
    for dnum=1:1:5
        ...
        x= cell2mat(raw(:, 1));
        Solution_Volume_Fraction(:,dnum,stepnum) = cell2mat(raw(:, 2));
